const Board = ({
  ...
  return (
    <div className="bg-white text-black flex flex-col mx-8 lg:mx-20 rounded-lg items-center md:items-start space-y-4 md:space-y-0 md:flex-row justify-between p-8 relative mb-[-18rem] md:-mb-10 relative" style={{
        zIndex: 1000
    }}>
